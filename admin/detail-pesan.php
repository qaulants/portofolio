...
//     $update = mysqli_query($koneksi, "UPDATE pesan SET nama='$nama', email='$email', no_hp='$no_hp', subject='$subject', isi_pesan='$isi_pesan' WHERE id = '$id'");

//   header("location:pesan.php?detail=berhasil");
// }
                  ...
                  <form action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3 row">
                      <div class="col-sm-6">
                        ...
                        <input required type="date" class="form-control" name="nama" value="<?php echo isset($_GET['detail']) ? $rowDetail['nama'] : '' ?>">
                      </div>
                      <div class="col-sm-6">
                    ...
                    <div class="mb-3 row">
                      <div class="col-sm-6">
                        ...
                        <textarea type="text" name="isi_pesan" class="form-control" readonly><?php echo isset($_GET['detail']) ? $rowDetail['deskripsi_diri'] : '' ?></textarea>
                      </div>
                    </div>
                    <div class="mb-3">
                      <button class="btn btn-primary" name="<?php echo isset($_GET['detail']) ? 'detail' : '' ?>" type="submit">
                        Simpan
                      </button>
                    </div>
                  </form>
